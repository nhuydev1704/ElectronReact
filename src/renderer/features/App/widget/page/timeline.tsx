...
import WithIconTimeLineItem from '../components/WithIconTimeLineItem';
const timeLineData = [
    {
        ...
        <Row>
            <Col span={24}>
                <div className="gx-page-heading">
                    <h2 className="gx-page-title">Timeline demo</h2>
                </div>
            </Col>
            <Col span={24}>
                <div className="gx-timeline-section gx-timeline-center">
                    ...
                    <WithIconTimeLineItem styleName="gx-timeline-inverted" timeLine={timeLineData[1]} color="purple">
