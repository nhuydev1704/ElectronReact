        ...
        >
            <div className="gx-text-center gx-pt-sm-3">
                <img
                    ...
                    src="https://wieldy.g-axon.work/assets/images/widget/birds.png"
                    alt="birds"
                />

                <h2 className="gx-mb-3 gx-mb-sm-4">WindsSoft frontend team</h2>
                ...
                <ul className="gx-list-inline gx-mb-3 gx-mb-lg-4">
                    ...
                    <li>
                        <Avatar className="gx-bg-primary gx-text-white">Ms</Avatar>
                    </li>
                    <li>
                        <span className="ant-avatar gx-border gx-border-grey gx-bg-transparent gx-text-grey">
